...
public class MechanicRestController {
    ...
    static final String API_MECHANIC = "/api/mechanic";
    static final String AVAILABLE_SERVICE_REQUESTS = "/availableServiceRequests";
    static final String MECHANIC_WORK_UNIT = "/workUnit";
